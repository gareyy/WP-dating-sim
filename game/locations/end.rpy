...
label ending:
    ...
    dafny "Of course, we went to the restaurant, and you ordered the tofu for me, the same thing I was thinking of ordering..."
    ...
    if good_lake:
        ...
        dafny "And it told us that we were something like soulmates."
        dafny "..."
    ...
    if good_pool:
        ...
        dafny "We were in our swimsuits, and you were like, awestruck by how I looked."
    ...
    if good_spa:
        ...
        dafny "And we decided to go into the hot tub together."
        dafny "And um..."
    ...
    dafny "And there were like, multiple endings to our day that didn't leave me happy."
    dafny "Even if they led to me going out with someone else..."

    show basil

    basil "I'm glad you trust me on that."
    ...
    basil "Because I am such a failure of a human being, and sometimes I felt like you were unapproachable."
...
label good_ending:
    ...
    basil "I just- I've never experienced anything else like this before."
