...
label start:
    ...
    basil "I feel like she's a piece of me that's missing."
    basil "But you know what? She's just a coworker."
    hide dafny
    basil "I don't know if she loves me, and I'm too scared to find out."
    basil "And maybe my own happiness..."
    basil "There may be a million fish in the sea, but I'd throw them all back if they weren't her."
    basil "Oh, heavens above! Please help me in my quest!"
    basil "I would do anything, even if it meant living the same day over and over again until I got it right!"
    ...
    basil "I finally implemented that big stupid component that was bugging me and Dafny."
    ...
    show basil
    basil "Wait, wh-"
    dafny "Well, when I said you were improving, I can definitely vouch for it."
    basil "Oh, really?"
    ...
    basil "I think it'd be cheaper if I ate with you today."
    show dafny blushing
    ...
    basil "Pfft."
    show dafny
    dafny "Is a compliment from me not enough?"
    dafny "You like my compliments, right?"
    basil "I somewhat live off them."
    dafny "Great! I'll take that as you paying for my meal?"
    basil "Only if I get to choose what we eat."
    dafny "Fine then, your pick."
    dafny "I hope you pick something good."
    dafny "Anyway, where should we go to eat?"
    basil "Eughhhh...."
    show basil thinking
